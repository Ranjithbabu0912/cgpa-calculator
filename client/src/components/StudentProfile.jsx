    ...
    <div className="student-profile glass-card">
      <div className="profile-info" style={{ flex: 1 }}>
        <table className="info-table">
          <tbody>
            <tr>
              <td className="info-label" style={labelStyle}>
                Register Number
              </td>
            ...
            <tr>
              ...
              <td style={valueStyle}>
                <span
                  style={{
                    color: data.results?.some(
                      (r) =>
                        r.status === "Fail" &&
                        r.isResultHolded !== "Y" &&
                        r.resultStatus !== "With Held",
                    )
                      ? "var(--danger)"
                      : data.results?.some(
                            (r) =>
      ...
      >
        <img
          src={
            data.photoUrl ||
            `https://ui-avatars.com/api/?name=${encodeURIComponent(data.student)}&background=6366f1&color=fff&size=120`
          }
          alt="Student Photo"
          style={{
            width: "100%",
