...
const AiGoalAdvisor = ({ data }) => {
  ...
  if (remainingSemesters > 0) {
    requiredSgpa =
      (targetCgpa * totalSemesters - currentCgpa * completedSemesters) /
      remainingSemesters;
    maxAchievableCgpa =
      (currentCgpa * completedSemesters + 10.0 * remainingSemesters) /
      totalSemesters;
  }
  ...
  const targetPercentage =
    targetCgpa > 0
      ? Math.min(100, Math.max(0, (currentCgpa / targetCgpa) * 100))
      : 0;
      ...
      <div className="glass-card no-print" style={settingsCardStyle}>
        <div className="ai-advisor-setup-grid">
          ...
          <div style={rightVisualPaneStyle}>
            ...
            <div
              style={{
                ...feasibilityBlockStyle,
                backgroundColor: feasibility.bgColor,
                borderColor: `${feasibility.color}25`,
              }}
            >
              <div
              ...
              >
                {requiredSgpa > 10 ? (
                  <AlertTriangle
                    size={18}
                    style={{ color: feasibility.color, flexShrink: 0 }}
                  />
                ) : (
                  <CheckCircle
                    size={18}
        ...
        {/* Unified CTA button */}
        <button onClick={fetchAiPlan} disabled={loading} style={aiBtnStyle}>
          {loading ? (
      ...
      <AnimatePresence>
        {advisorData && !loading && (
          ...
          >
            ...
            <div className="glass-card" style={summaryCardStyle}>
              <div style={summaryHeaderStyle}>
                ...
                <span style={sourceBadgeStyle(advisorData.source)}>
                  {advisorData.source === "openai" ||
                  advisorData.source === "gemini"
                    ? "✨ AI-Powered"
                    : "⚙️ Local System"}
                </span>
              </div>
              ...
              <p style={summaryTextStyle}>
                {formatAiText(advisorData.summary)}
              </p>

              <div
                style={{
                  ...feasibilityBoxStyle,
                  borderLeft: `4px solid ${feasibility.color}`,
                }}
              >
                <div
                  style={{
                ...
                >
                  {formatAiText(advisorData.feasibility)}
                </div>
              </div>
            </div>
            ...
            <div
              className="ai-response-dashboard-grid"
            ...
            >
              ...
              <div className="glass-card" style={roadmapCardStyle}>
                ...
                <div
                  className="ai-advisor-timeline"
                  style={timelineContainerStyle}
                >
                  {advisorData.semesterRoadmap &&
                  advisorData.semesterRoadmap.length > 0 ? (
                        ...
                        <div style={timelineContentStyle}>
                          <div style={timelineHeaderStyle}>
                            <span style={timelineTitleStyle}>
                              Semester {item.semester} Target
                            </span>
                            <span style={timelineTargetBadgeStyle}>
                              {item.targetSgpa.toFixed(2)} SGPA
                            </span>
                          </div>
                          <p style={timelineDescriptionStyle}>
                            {formatAiText(item.focusAreas)}
                          </p>
                        </div>
                      </div>
                    ))
              ...
              <div className="glass-card" style={roadmapCardStyle}>
                ...
                <div style={subjectListStyle}>
                  {advisorData.subjectStrategies &&
                  advisorData.subjectStrategies.length > 0 ? (
                      ...
                      <div key={idx} style={subjectItemStyle}>
                        <div style={subjectHeaderStyle}>
                          <div style={subjectTitleContainerStyle}>
                            ...
                            <span style={subjectCodeStyle}>
                              {subj.subjectCode}
                            </span>
                          </div>
                          <span
                            style={subjectGradeBadgeStyle(subj.currentGrade)}
                          >
                            Grade: {subj.currentGrade}
                          </span>
                        </div>
                        <p style={subjectAdviceStyle}>
                          {formatAiText(subj.strategy)}
                        </p>
                      </div>
                    ))
                  ) : (
            ...
            <div className="glass-card" style={tipsCardStyle}>
              ...
              <ul style={tipsListStyle}>
                {advisorData.generalTips &&
                  advisorData.generalTips.map((tip, idx) => (
                    <li key={idx} style={tipsItemStyle}>
                      ...
                      <span style={tipsTextStyle}>{formatAiText(tip)}</span>
                    </li>
                  ))}
              </ul>
            </div>
